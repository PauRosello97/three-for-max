...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 196.0, 50.0, 64.0 ],
					"text" : "dictionary u302004097"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 113.0, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 54.5, 222.0, 36.0 ],
					"text" : ";\r\nmax launchbrowser http://localhost:2112"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 4.083333333333336, 192.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 535.0, 95.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 471.0, 204.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 61.0, 144.0, 235.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"watch" : 0
...
,
					"text" : "node.script three_template.js @autostart 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 535.0, 65.0, 150.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 286.5, 182.0, 480.5, 182.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"name" : "three_template.js",
				"bootpath" : "~/Desktop/TIME_TUNNEL/node_for_max/three_template",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
